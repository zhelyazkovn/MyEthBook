...
// it("should invite friend", async function(){
	 // let options = {
				// from: user1
            // };
	// let result = await myEthBook.inviteFriend('pena@abv.bg',options);
		
	// assert.strictEqual(JSON.parse(result),true,"should invite friend");
// })

// it("should get refferals", async function(){
	 // let options = {
				// from: user1
            // };
	// await myEthBook.addContact('Pena','0xca35b7d915458ef540ade6068dfe2f44e8fa733c',options);
	
	// let result = await myEthBook.getContact(0,user1,options);
	
	// assert.strictEqual(result.name,'Pena',"hould get refferals");
// })

// it("should get invited and accepted count", async function(){
	 // let options = {
				// from: user1
            // };
	// await myEthBook.addContact('Pena','0xca35b7d915458ef540ade6068dfe2f44e8fa733c',options);
	...
	// assert.strictEqual(result.name,'Pena',"should get invited and accepted count");
// })


// it("should add address to the book", async function(){
	 // let options = {
				// from: user1
            // };
	// await myEthBook.addContact('Pena','0xca35b7d915458ef540ade6068dfe2f44e8fa733c',options);
	...
	// assert.strictEqual(result.name,'Pena',"should add address to the book");
// })


// it("should edit address", async function(){
	 // let options = {
				// from: user1
            // };
	// await myEthBook.addContact('Pena','0xca35b7d915458ef540ade6068dfe2f44e8fa733c',options);
	...
	// assert.strictEqual(result.name,'Pena',"should edit address");
// })
...
// it("should delete address", async function(){
	...
	// assert.strictEqual(result.name,'Pena',"should delete address");
// })
